...
\u2022 Malmö Universitets dataskyddsombud via dataskyddsombud@mau.se`,
  ...
  scheduling: {
    ...
    fromDaysConsented: 'Dagen efter jag har gett ditt samtycke | {n} dagar efter att jag har gett ditt samtycke',
    fromTaskExecuted: '{days} dagar efter att jag har slutfört uppgiften {taskId}',
    untilDaysConsented: 'Till {days} dagar efter att jag har gett ditt samtycke',
    untilTaskExecuted: 'Till {days} dagar efter att jag har slutfört uppgiften {taskId}',
